...
class detalle_matricula extends f
{
    var $modelo = "";
    var $html_basico = "";
    var $html = "";
    var $baseurl = "";
    var $modelo2 = "";
    function detalle_matricula()
    {
        session_start();
        $this->html_basico = $this->load()->lib("Html_basico");
        $this->html        = $this->load()->lib("html_detalle_matricula");
    ...
    {
        $sql = "SELECT a.id, a.apellidos, a.nombres, date(m.fecha_creacion) fecha, g.grado FROM matriculas as m join usuarios as a on a.id = m.id_alumno AND m.id_grado = " . $_GET['id_grado']. " JOIN grados as g on g.id = m.id_grado";
